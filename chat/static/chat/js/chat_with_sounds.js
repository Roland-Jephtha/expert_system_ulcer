...
const typingSound = new Audio('https://assets.mixkit.co/sfx/preview/mixkit-fast-typing-on-mechanical-keyboard-1881.mp3');
...
function hideTypingIndicator() {
    if (typingIndicator) {
        ...
        // Stop typing sound when hiding indicator
        typingSound.pause();
